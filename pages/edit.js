    ...
    setData({
      ...
      projects: [
        ...data.projects,
        {
          ...
          url: "https://github.com/manya-imran/",
        },
      ],
    });
  };
    ...
    setData({
      ...
      socials: [
        ...data.socials,
        {
          id: uuidv4(),
          title: "New Link",
          link: "https://github.com/manya-imran/",
        },
      ],
    });
  };
    ...
    <div className={`container mx-auto ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="mt-10">
        ...
        {currentTabs === "HEADER" && (
          <div className="mt-10">
            <div className="flex items-center">
              <label className="w-1/5 text-lg opacity-50">Home</label>
              <input
                value={home}
                onChange={(e) => setData({ ...data, home: e.target.value })}
            ...
            <div className="mt-5 flex items-center w-1/2 h-1/2">
